...
if ($sta==44){
    ...
    --((z.USRA_KOD is null) or (z.USRA_KOD='')) AND
     (z.DATAWYST BETWEEN dateadd(day, -4, GETDATE()) AND GETDATE())
...
$sql="
SELECT TOP 30 sub.oznaczenie AS Numer, COUNT(sub.kod) AS ilosc, sub.st AS sta
    FROM (
    SELECT
    iw.mag_kod AS kod, iw.mag_kod+'-'+iw.sww_b+'-'+iw.sww_p+'-'+iw.sww_a+'-'+iw.sww_t+'-'+iw.naw_kod+'-'+iw.jm_kod ID,
    nt.nazwa, iw.MAG_SEKCJA Lokalizacja, iw.KOD_TOW, iw.EAN1,
    ...
    --AND 
	(z.DATAWYST BETWEEN dateadd(day, -4, GETDATE()) AND GETDATE()) AND z.dz_kod='00'
