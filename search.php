...
//     SELECT sub.oznaczenie AS Numer, COUNT(sub.kod) AS ilosc, sub.st AS sta
//     FROM (
//     SELECT
//     iw.mag_kod AS kod, iw.mag_kod+'-'+iw.sww_b+'-'+iw.sww_p+'-'+iw.sww_a+'-'+iw.sww_t+'-'+iw.naw_kod+'-'+iw.jm_kod ID,
//     nt.nazwa, iw.MAG_SEKCJA Lokalizacja, iw.KOD_TOW, iw.EAN1, sum (tv.ILR) ILR, naw.ILOSC_NAW, Sum(tv.ilr * iw.WAGA_N) Waga, jm.NAZWA JednostkaMiary, 
//     'SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr AS oznaczenie, dd.[status] AS st
...
//     WHERE ((z.USRA_KOD is null) or (z.USRA_KOD='')) AND (z.DATAWYST BETWEEN dateadd(day, -3, '2022-06-06') AND '2022-06-06') AND
//     ('SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr LIKE '%'+'$search'+'%') AND dd.[status]='$sta'


//     GROUP BY
//     iw.mag_kod,
//     iw.mag_kod+'-'+iw.sww_b+'-'+iw.sww_p+'-'+iw.sww_a+'-'+iw.sww_t+'-'+iw.naw_kod+'-'+iw.jm_kod,
//     nt.nazwa,iw.MAG_SEKCJA,iw.KOD_TOW,iw.EAN1,naw.ILOSC_NAW,jm.NAZWA,
//     'SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr,dd.[status]
//     ) sub

//     GROUP BY sub.oznaczenie, sub.st;
//     ";
// }else{
//     $sql="
//     SELECT sub.oznaczenie AS Numer, COUNT(sub.kod) AS ilosc, sub.st AS sta
...
//     WHERE ((z.USRA_KOD is null) or (z.USRA_KOD=''))  AND (z.DATAWYST BETWEEN dateadd(day, -3, '2022-06-06') AND '2022-06-06') AND
//     ('SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr LIKE '%'+'$search'+'%') AND dd.[status] is null
...
//         $answer["zamowienia"][$i]['sta'] =  '<svg onclick="searchIn (2,0)" style="color: blue" xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16"> <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z" fill="blue"></path> <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" fill="blue"></path> </svg>';
//         $i++; 
//     }
//     else   {
