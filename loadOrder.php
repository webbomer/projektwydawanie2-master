...
$sql="SELECT TOP 30 sub.oznaczenie AS Numer, COUNT(sub.kod) AS ilosc, sub.st AS sta
    ...
    WHERE 
	--((z.USRA_KOD is null) OR (z.USRA_KOD IN ('',' '))) 
    --AND 
	(z.DATAWYST BETWEEN dateadd(day, -30, GETDATE()) AND GETDATE()) AND z.dz_kod='00' AND (( dd.kww_user='$user') OR ( dd.kww_user is null))
	AND 'SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr LIKE '%'
...
// WHERE ((z.USRA_KOD is null) or (z.USRA_KOD='')) 
// AND (z.DATAWYST BETWEEN dateadd(day, -10, GETDATE()) AND GETDATE()) AND (( dd.kww_user='$user') OR ( dd.kww_user is null))
// GROUP BY
// iw.mag_kod, iw.mag_kod+'-'+iw.sww_b+'-'+iw.sww_p+'-'+iw.sww_a+'-'+iw.sww_t+'-'+iw.naw_kod+'-'+iw.jm_kod,
// nt.nazwa, iw.MAG_SEKCJA, iw.KOD_TOW, iw.EAN1,
// jm.NAZWA, 'SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr, dd.[status], naw.ILOSC_NAW, dd.kww_user
...
//komenda
// $sql = " SELECT 
// 'SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr AS Numer 
// FROM gm.DokSPNag z 
// WHERE ((z.USRA_KOD is null) or (z.USRA_KOD='')) AND z.DZ_KOD='00' AND z.rr='$VarRok' ";

// $sql="SELECT sub.oznaczenie AS Numer, COUNT(sub.kod) AS ilosc
// FROM (
// SELECT
// iw.mag_kod AS kod, iw.mag_kod+'-'+iw.sww_b+'-'+iw.sww_p+'-'+iw.sww_a+'-'+iw.sww_t+'-'+iw.naw_kod+'-'+iw.jm_kod ID,
...
// 'SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr AS oznaczenie
...
// 'SP ' + z.dz_kod + '/' + z.nr + '/' + z.mc + '/' + z.rr
// ) sub
// GROUP BY sub.oznaczenie;";
?>